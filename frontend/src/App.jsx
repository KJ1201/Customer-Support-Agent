    ...
    <div className="app-container">
      ...
      {!loadingResult && callResult && (
        <div className="call-result">
          ...
          <p>
            Product: {typeof callResult?.analysis?.structuredData?.productName !== "undefined"
              ? String(callResult.analysis.structuredData.productName)
              : "Unknown"}
          </p>
          <p>
            Status: {typeof callResult?.analysis?.structuredData?.resolutionStatus !== "undefined"
              ? String(callResult.analysis.structuredData.resolutionStatus)
              : "Unknown"}
          </p>
          <p>
            Issue: {typeof callResult?.analysis?.structuredData?.issueDescription !== "undefined"
              ? String(callResult.analysis.structuredData.issueDescription)
              : "Unknown"}
          </p>
